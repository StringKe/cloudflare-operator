...
// +kubebuilder:deprecatedversion:warning="networking.cloudflare-operator.io/v1alpha1 ClusterTunnel is deprecated, see https://github.com/adyanth/cloudflare-operator/tree/v0.13.0/docs/migration/crd/v1alpha2.md for migrating to v1alpha2"
