...
// It compares the state specified by the ClusterTunnel object against the actual
// cluster state, and then performs operations to make the cluster state reflect
